...
const cols = [
  { id: 'headline', numeric: false, disablePadding: true, label: '' },
];
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <AddIcon className={classes.icon} onClick={() => onCreate(newHeadline)}/>
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <EnhancedTableToolbar numSelected={selected.length} onCreate={onCreate}/>
